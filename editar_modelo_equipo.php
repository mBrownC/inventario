...
<body>
    <div class="sidenav-header">
        ...
        <form action="actualizar_modelo_equipo.php" method="POST" class="custom-form" style="margin-top: 50px;">
<div class="form-group">
            ...
            <div class="form-group button-container">
                ...
                <a class="btn btn-warning" href="mantenedores.php#tabs-3">Volver</a>
            </div>
