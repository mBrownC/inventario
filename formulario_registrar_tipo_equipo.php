  ...
  <div class="sidenav-header">
    <div class="row">
      <div class="col-12">
                        ...
                        <form action="registro_tipo_equipo.php" method="POST" class="custom-form" style="margin-top: 50px;">
                            ...
                            <div class="form-group button-container"><button class="btn btn-success">Guardar</button>
