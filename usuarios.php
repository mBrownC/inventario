...
if (isset($_SESSION["name"])) {
    ...
    $colActivos = $mysqli->query("SELECT * FROM colaborador WHERE estado_colaborador = 1 order by nombre_colaborador asc");
    $colDesv = $mysqli->query("SELECT * FROM colaborador WHERE estado_colaborador = 0 order by nombre_colaborador asc");
    $colaboradoresActivos = $colActivos->fetch_all(MYSQLI_ASSOC);
    $colaboradoresDesvinculados = $colDesv->fetch_all(MYSQLI_ASSOC);
?>
    ...
    <body class="g-sidenav-show  bg-gray-100">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Colaboradores / Actas</h6>
                    </nav>
            ...
            <div class="container-fluid py-4">
                ...
                <div id="tabs">
                    <ul>
                        <li><a href="#tabs-1">Colaboradores Activos</a></li>
                        <li><a href="#tabs-2">Ex Colaboradores</a></li>
                    </ul>
                    <!-- Pestaña Colaboradores Activos -->
                    <div id="tabs-1">
                        <div class="container-fluid py-4">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header pb-0">
                                            <h6>Tabla Colaboradores Activos</h6>
                                                        ...
                                                        foreach ($colaboradoresActivos as $colaborador) { ?>
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <div class="d-flex px-2 py-1">
                                                                        <div class="d-flex flex-column justify-content-center">
                                                                            <h6 class="mb-0 text-sm">
                                                                                <?php echo $colaborador["nombre_colaborador"] . " " . $colaborador["apellido_pat_colaborador"] . " " . $colaborador["apellido_mat_colaborador"]; ?>
                                                                            </h6>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="align-middle text-center text-sm">
                                                                    <?php echo $colaborador["rut_colaborador"] ?>
                                                                </td>
                                                                <td class="align-middle text-center text-sm">
                                                                    <?php echo $colaborador["mail_colaborador"] ?>
                                                                </td>
                                                                <td class="align-middle text-center text-sm">
                                                                    <?php echo $colaborador["celular_mda_colaborador"] ?>
                                                                </td>
                                                                <td class="align-middle text-center">
                                                                    <a <?php if ($colaborador["equipo_devolucioln"] == 0 and $colaborador["equipo_entregado"] == 0 and $colaborador["equipo_colaborador"] == 0) {
                                                                ...
                                                                <td class="align-middle">
                                                                    ...
                                                                    <a <?php if ($colaborador["equipo_devolucioln"] <> 1) {
                                                                            echo "style='display:none;'";
                                                                        }
                    ...
                    <div class="container-fluid py-4">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-success btn-sm" href="generar_reporte_desvinculados.php">Generar Reporte Desvinculados</a>
                                    <div class="card mb-4">
                                        <div class="card-header pb-0">
                                            <h6>Tabla Ex Colaboradores</h6>
                                            ...
                                            <div class="table-responsive p-0">
                                                <table class="table align-items-center mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        foreach ($colaboradoresDesvinculados as $colaboradordes) { ?>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex px-2 py-1">
                                                                        <div class="d-flex flex-column justify-content-center">
                                                                            <h6 class="mb-0 text-sm">
                                                                                <?php echo $colaboradordes["nombre_colaborador"] . " " . $colaboradordes["apellido_pat_colaborador"] . " " . $colaboradordes["apellido_mat_colaborador"]; ?>
                                                                            </h6>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="align-middle text-center text-sm">
                                                                    <?php echo $colaboradordes["rut_colaborador"] ?>
                                                                </td>
                                                                <td class="align-middle text-center text-sm">
                                                                    <?php echo $colaboradordes["mail_colaborador"] ?>
                                                                </td>
                                                                <td class="align-middle text-center text-sm">
                                                                    <?php echo $colaboradordes["celular_mda_colaborador"] ?>
                                                                </td>
                                                                <td class="align-middle">

                                                                    <a <?php if ($colaboradordes["equipo_devolucioln"] <> 1) {
                                                                            echo "style='display:none;'";
                                                                        }

                                                                        echo "href='./pdfeasy/acta_devolucion_pdf.php?id=" . $colaboradordes['id_colaborador'] . "'target='_blank'";
        ...
        <!-- Scrip necesarios para los tabs -->
